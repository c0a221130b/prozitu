...
# def images_split(imgs):
#     train, test = train_test_split(imgs, test_size=0.20)
#     return train, test
...
def main():
    ...
    LOAD_TRAIN_IMG0S_PATH = './bainari/train_num/*'
    LOAD_TRAIN_IMG1S_PATH = './bainari/train_str/*'
#    LOAD_TRAIN_IMG2S_PATH = 'C:/github/sample/python/opencv/svm/ex1_data/img2/*'
    ...
    LOAD_TEST_IMG0S_PATH = './bainari/test_num/*'
    LOAD_TEST_IMG1S_PATH = './bainari/test_str/*'
...
#    LOAD_TEST_IMG2S_PATH = 'C:/github/sample/python/opencv/svm/ex1_data/test_img2/*'
    ...
    test_imgs = np.r_[test_imgs0, test_imgs1]
